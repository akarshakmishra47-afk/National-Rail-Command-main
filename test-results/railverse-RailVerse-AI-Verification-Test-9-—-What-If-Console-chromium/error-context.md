...
- Name: railverse.spec.ts >> RailVerse AI Verification >> Test 9 — What-If Console
- Location: tests\e2e\railverse.spec.ts:141:7
...
Call log:
  - waiting for locator('#whatif-input')
    - locator resolved to <textarea rows="3" id="whatif-input" placeholder="e.g. What happens if Train 22416 is delayed 90 minutes during Kumbh Mela at Prayagraj?"></textarea>
    - fill("What happens if Train 22416 is delayed by 90 minutes during a festival surge in Varanasi?")
