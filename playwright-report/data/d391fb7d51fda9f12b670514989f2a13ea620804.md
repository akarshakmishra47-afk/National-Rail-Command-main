...
- Name: railverse.spec.ts >> RailVerse AI Verification >> Test 4 — SSE Connectivity
- Location: tests\e2e\railverse.spec.ts:63:7
...
Locator: locator('#net-status-text')
Expected substring: "LIVE"
Timeout: 10000ms
Error: element(s) not found

Call log:
  - Expect "toContainText" locator('#net-status-text') with timeout 10000ms
  - waiting for locator('#net-status-text')
