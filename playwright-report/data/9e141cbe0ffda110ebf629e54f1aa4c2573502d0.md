...
- Name: railverse.spec.ts >> RailVerse AI Verification >> Test 1 — Original UI
- Location: tests\e2e\railverse.spec.ts:41:7
...
Call log:
  - Expect "toBeVisible" locator('#map') with timeout 5000ms
